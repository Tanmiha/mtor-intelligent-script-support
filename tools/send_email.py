...
SMTP_PORT = 587
SENDER_EMAIL = "coder6514@gmail.com"
SENDER_PASSWORD = "jcpmwlqwiwtbnblq"  # Use App Password for Gmail
...
def escalate_ticket_with_email(issue: str) -> dict:
    ...
    success = send_email(to_email="coder6514@gmail.com", subject=subject, body=body)
